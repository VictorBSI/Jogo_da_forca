...
public class Temas implements Resultados{
	private String[][] temas = {{"cachorro", "gato", "jacaré", "gaivota", "pato", "morcego", "elefante", "girafa", "macaco", "baleia", "rato", "lobo", "tigre", "panda", "urso", "tubarão", "lagarto", "sapo", "cobra", "vaca", "boi", "touro", "escorpião", "aranha", "barata", "gavião", "zebra", "ornitorrinco", "beija-flor"}, {"cama", "mesa", "ventilador", "geladeira", "fogão", "chave", "televisão", "rádio", "computador", "armário", "telefone", "celular", "cadeira", "pia", "escada", "carro", "bicicleta", "termômetro", "mouse"}, {"titanic", "matrix", "avatar", "kill bill", "as crônicas de nárnia", "harry potter", "o senhor dos anéis", "as panteras", "karatê kid", "motoqueiro fantasma", "homem-aranha"}, {"lenhador", "professor", "médico", "administrador", "carpinteiro", "advogado", "juíz", "promotor", "engenheiro", "enfermeiro", "pintor", "cantor", "ator", "atriz", "modelo", "diretor", "motorista", "telefonista", "ginasta", "gerente", "nadador", "vendedor"}, {"maçã", "abacaxi", "melão", "melancia", "pêra", "mamão", "abacate", "laranja", "tangerina", "banana", "açaí", "pupunha", "ameixa"}, {"belém", "maceió", "manaus", "recife", "londres", "paris", "lisboa", "brasília", "fortaleza", "cuiabá", "florianópolis", "madrid", "palmas", "curitiba", "são paulo", "rio de janeiro", "belo horizonte", "porto alegre", "salvador", "são luís", "macapá"}, {"paysandu", "remo", "tuna", "corinthians", "palmeiras", "juventude", "bahia", "fortaleza", "flamengo", "barcelona", "grêmio", "internacional", "cruzeiro", "são paulo", "real madrid"}};
	...
	public void mostrarResultados() {
		System.out.println("\nTemas: Animais, Objetos, Filmes, Profissões, Frutas, Cidades, Times\n");
	}
